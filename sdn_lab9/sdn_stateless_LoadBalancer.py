#Stateless LoadBalancer application for Ryu controller
...
#application class
class Parth_Stateless_LoadBalancer(app_manager.RyuApp):
    #Specifying OpenFlow version
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(Parth_Stateless_LoadBalancer, self).__init__(*args, **kwargs)
    ...
    def _packet_in_handler(self, ev):
        ...
        if eth.ethertype == 0x0800:
            ...
            if raw_ip.proto == 0x01 and raw_ip.dst == "10.0.0.100":
                ...
                add_flow_1 = parser.OFPFlowMod(datapath=datapath, match=match_1, idle_timeout=1, instructions=instructions_1, buffer_id=msg.buffer_id, cookie=cookie)
                ...
                #Creating a FlowMod packet to be sent to the switch
                add_flow_2 = parser.OFPFlowMod(datapath=datapath, match=match_2, idle_timeout=1, instructions=instructions_2, cookie=cookie)
