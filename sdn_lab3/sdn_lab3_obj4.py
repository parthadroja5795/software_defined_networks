#script to automate the OvS configuration on linux server and verify the same
...
if __name__ == "__main__":
	...
	commands=[
	"echo parthsdn | sudo -S ovs-vsctl add-br P_bridge_MGMT_G",
	"echo parthsdn | sudo -S ovs-vsctl add-port P_bridge_MGMT_G eno1",
	"echo parthsdn | sudo -S ovs-vsctl set-controller P_bridge_G tcp:10.20.30.2:6633"
	]
	...
	x=subprocess.Popen(["echo parthsdn | sudo -S ovs-vsctl show"],shell=True,stdout=subprocess.PIPE)
	y=x.communicate()[0]
	z=y.decode("ascii")
